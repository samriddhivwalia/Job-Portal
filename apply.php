            ...
            <div class="col-md-6">
                 <form action="apply.php" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" value="<?=$userid?>" name="userid" >
                    ...
                    <input type="text" placeholder="give drive of your cv" name="email" class="form-control">
                    </div>
                    
                    <input type="submit"  name="applyjob" value="Apply for the job" class="btn btn-primary">
